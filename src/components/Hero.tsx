export default function Hero() {
  return (
    <section className="relative px-6 pb-20 pt-32 lg:pt-36">
      <div className="absolute left-1/2 top-16 -z-0 h-72 w-72 -translate-x-1/2 rounded-full bg-blue-200/40 blur-3xl" />
      <div className="relative z-10 mx-auto grid max-w-7xl items-center gap-12 lg:grid-cols-[1.05fr_0.95fr]">
        <div>
          ...
          <div className="mt-9 flex flex-col gap-4 sm:flex-row">
            <a
              href="#restaurants"
              className="rounded-full bg-gradient-to-r from-blue-500 to-indigo-500 px-8 py-4 text-center text-base font-black text-white shadow-2xl shadow-blue-300 transition hover:-translate-y-1 hover:from-blue-600 hover:to-indigo-600"
            >
              Browse restaurants
            </a>
            <a
        ...
        <div className="relative">
          <div className="absolute -right-6 -top-6 h-36 w-36 rounded-full bg-blue-200/50 blur-2xl" />
          <div className="relative rounded-[2.5rem] bg-stone-950 p-4 shadow-2xl shadow-blue-200">
            <div className="overflow-hidden rounded-[2rem] bg-gradient-to-br from-blue-50 via-white to-indigo-50 p-6">
              ...
              <div className="mt-6 grid grid-cols-2 gap-4">
                ...
                <div className="rounded-[2rem] bg-gradient-to-br from-blue-500 to-indigo-500 p-5 text-white shadow-lg shadow-blue-300">
                  <div className="text-6xl">🥗</div>
