...
export default function CategoryStrip() {
  return (
    <section id="popular" className="px-6 py-8">
      <div className="mx-auto max-w-7xl rounded-[2.5rem] bg-white p-5 shadow-xl shadow-blue-100">
        <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-5">
          {categories.map((category) => (
            <div
              key={category.name}
              className="group rounded-[2rem] border border-blue-100 bg-blue-50/70 p-5 transition hover:-translate-y-1 hover:border-blue-300 hover:bg-blue-100"
            >
