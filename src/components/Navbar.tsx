    ...
    <header className="fixed inset-x-0 top-0 z-30 border-b border-white/60 bg-stone-50/85 backdrop-blur-xl">
      <nav className="mx-auto flex max-w-7xl items-center justify-between px-6 py-4">
        <a href="#top" className="flex items-center gap-3" aria-label="Go to top">
          <span className="flex h-11 w-11 items-center justify-center rounded-2xl bg-gradient-to-br from-orange-500 to-pink-500 text-2xl shadow-lg shadow-orange-300/50">🍽️</span>
          <span>
