export default function Navbar() {
  return (
    <header className="fixed inset-x-0 top-0 z-30 border-b border-white/60 bg-blue-50/85 backdrop-blur-xl">
      <nav className="mx-auto flex max-w-7xl items-center justify-between px-6 py-4">
        <a href="#top" className="flex items-center gap-3" aria-label="Go to top">
          <span className="flex h-11 w-11 items-center justify-center rounded-2xl bg-blue-500 text-2xl shadow-lg shadow-blue-300/50">🍽️</span>
          <span>
        ...
        <div className="hidden items-center gap-8 rounded-full bg-white/80 px-6 py-3 text-sm font-bold text-stone-600 shadow-sm shadow-blue-100 md:flex">
